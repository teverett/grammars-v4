import { Parser, TokenStream, CommonTokenStream, Token, CharStream } from 'antlr4ng';
import { Protobuf3Parser, DoMessageNameDefContext, MessageDefContext, DoEnumNameDefContext, EnumDefContext, DoServiceNameDefContext, ServiceDefContext, ImportStatementContext } from './Protobuf3Parser.js';
...
export abstract class Protobuf3ParserBase extends Parser {
    private debug = false;
